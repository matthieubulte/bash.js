...
Core.prototype._runExpression = function(tree) {
    ...
    if(firstChild instanceof Tree.Leaf &&
       firstChild.type === Tree.Leaf.Type.SYM &&
...
Core.prototype._runLeaf = function(leaf) {
    if(leaf.type === Tree.Leaf.Type.SYM) {
